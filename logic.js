...
function check(index) {
	...
	for (var i = 0; i < tests[index][1].length; i++) {
		if (i % 2 == 0) {
			...
			checkTable.innerHTML += `<tr><td style="background: #fff6d3; width: 50%; border-radius: 5px;">${tests[index][1][i]}</td><td style="width: 50%;">${tests[index][2][i]}</td><tr>`;
		}
	}
}
